...
<>
      ...
      >
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <div className="w-12 h-12 bg-card/10 rounded-2xl flex items-center justify-center mb-4 backdrop-blur-sm">
              <Upload className="w-6 h-6 text-card-foreground" />
            </div>
            <h2 className="text-2xl font-serif mb-2">Upload New Material</h2>
            <p className="text-muted-foreground max-w-md">
              Drag and drop your audio lectures or PDF notes here to instantly
              generate study aids.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button
              variant="ghost"
              className="text-sm text-primary hover:text-primary hover:bg-transparent hover:underline px-0"
          ...
          {recentJobs.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-muted-foreground mb-4">
                No recent activity yet. Upload your first file to get started!
              </p>
            ...
            <div className="space-y-4">
              {recentJobs.map((job: any) => (
                <Card
                  ...
                  onClick={() => router.push(`/notes/${job.id}`)}
                >
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="rounded-full text-muted-foreground hover:text-muted"
                  >
        ...
        <div className="space-y-6">
          <Card className="p-6 bg-background border-border shadow-sm">
            <h3 className="font-medium text-muted-foreground text-sm mb-1 uppercase tracking-wider">
              Total Notes
            </h3>
