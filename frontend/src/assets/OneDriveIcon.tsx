...
const OneDriveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
    ...
    >
      <defs>
        ...
        >
          <stop
            stopColor="rgb(28.235294%,58.039216%,99.607843%)"
            stopOpacity="1"
            offset="0"
          />
          <stop
        ...
        >
          ...
          />
          <stop
            stopColor="rgb(10.980392%,56.862745%,100%)"
            stopOpacity="1"
            offset="0.534"
          />
        </radialGradient>
        ...
        >
          <stop stopColor="rgb(100%,100%,100%)" stopOpacity="0.4" offset="0" />
          <stop
            stopColor="rgb(67.843137%,75.294118%,100%)"
            stopOpacity="0"
            offset="0.660528"
          />
        </radialGradient>
        ...
        >
          <stop
            stopColor="rgb(1.176471%,22.745098%,80%)"
            stopOpacity="1"
            offset="0"
          />
          <stop
            stopColor="rgb(21.176471%,55.686275%,100%)"
            stopOpacity="0"
            offset="1"
          />
        </radialGradient>
        ...
        >
          <stop stopColor="rgb(0%,52.54902%,100%)" stopOpacity="1" offset="0" />
          <stop
            stopColor="rgb(0%,73.333333%,100%)"
            stopOpacity="1"
            offset="0.49"
          />
        </linearGradient>
