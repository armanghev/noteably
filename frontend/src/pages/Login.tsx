...
export default function Login() {
  ...
  // Handle OAuth return: if user is authenticated, redirect appropriately
  useEffect(() => {
    if (user && searchParams.get("oauth") === "1") {
      if (!profileCompleted) {
        ...
        <div className="relative z-10 flex flex-col justify-between p-10 w-full">
          ...
          <div className="flex-1 flex flex-col justify-center pb-12 mb-auto">
            <h1 className="text-4xl xl:text-5xl font-serif font-bold text-white mb-6 leading-tight">
              Transform any content<br />into study materials
            </h1>
            <p className="text-lg text-white/70 mb-12 max-w-md">
              Upload lectures, PDFs, or videos and let AI create summaries, flashcards, and quizzes in seconds.
            </p>
